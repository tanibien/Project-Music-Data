...
> **Live Demo:** [https://tanibien.github.io/Project-Music-Data/](https://tanibien.github.io/Project-Music-Data/)
...
* **Artist Search (API Ready):** Integrated search functionality with a secure architecture for external API calls.
...
* **Secret Management:** API keys are managed via a local `config.mjs` file (excluded from the repository for security) to follow industry safety standards.
